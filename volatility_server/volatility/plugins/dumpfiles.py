    ...
    def render_text(self, outfd, data):
        ...
        for summaryinfo in data:
            ...
            if summaryinfo['type'] == "DataSectionObject":
                ...
                instance = location[-1].split('.')
                path = summaryinfo['name']
                of = open(self._config.DUMP_DIR + instance[0] + '_' + path, 'wb')
                ...
                location = location.split('/')
                instance = location[-1].split('.')
                of = open(self._config.DUMP_DIR + instance[0] + '_' + summaryinfo['name'], 'wb')
